package com.sujoy.plantcare.Screens
...
import com.sujoy.plantcare.AuthApi.RetrofitInstance
import com.sujoy.plantcare.Pref.UserPreferences
import com.sujoy.plantcare.R
...
@Composable
fun LoginUI(modifier: Modifier = Modifier, navController: NavHostController, userPreferences: UserPreferences) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Text(text = "Welcome Again", fontSize = 27.sp, color = Color.Black, fontWeight = FontWeight.Bold)
            ...
            Button(onClick = {
                ...
                Text(text = "Login", fontSize = 18.sp, fontWeight = FontWeight.Bold, color = Color.White, modifier=Modifier.padding(3.dp))
            }
            Spacer(modifier = Modifier.height(15.dp))
            Row(modifier=Modifier.fillMaxWidth(),
                horizontalArrangement = Arrangement.Center) {
                Text(text = "Don't have an account?", fontSize = 15.sp, color = Color.Black)
                Spacer(modifier = Modifier.width(5.dp))
                Text(text = "Sign Up", fontSize = 15.sp, color = Color(0xFF00695C), fontWeight = FontWeight.Bold, modifier=Modifier.clickable { navController.navigate(Routes.SignUp) })
            }
        }
    }
}